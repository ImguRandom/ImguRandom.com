	...
	var Imgur = {
		fetch: function(num) {
			...
			for (let i = 0; i < num; i++) {
				self.hunt(function(id) {
					...
					$(images_el).append("<div class=\"image\"><a href=\"https://i.imgur.com/" + id + "_d.webp?maxwidth=10000&fidelity=grand\" target=\"_blank\" rel=\"noreferrer\"><img src=\"https://i.imgur.com/" + id + "s.png\" height=\"110\" width=\"110\" /></a><button id=\"favorite\" value=\"" + id + "\"><i class=\"fa fa-heart\"></i></button></div>");
		...
		hunt: function(cb) {
			...
			function fail() {
				...
				{
					$(filteredimages_el).append("<div class=\"image\"><a href=\"https://i.imgur.com/" + id + "_d.webp?maxwidth=10000&fidelity=grand\" target=\"_blank\" rel=\"noreferrer\"><img src=\"https://i.imgur.com/" + id + "s.png\" height=\"110\" width=\"110\" /></a><button id=\"favorite\" value=\"" + id + "\"><i class=\"fa fa-heart\"></i></button></div>");
				}
