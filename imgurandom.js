	...
	var Imgur = {
		fetch: function(num) {
			...
			for (let i = 0; i < num; i++) {
				self.hunt(function(id) {
					...
					$(images_el).append("<a href=\"https://i.imgur.com/" + id + "_d.png?maxwidth=10000&fidelity=high\" target=\"_blank\" rel=\"noreferrer\"><img src=\"https://i.imgur.com/" + id + "s.png\" height=\"110\" width=\"110\" /></a>");
		...
		hunt: function(cb) {
			...
			function fail() {
				...
				{
					$(filteredimages_el).append("<a href=\"https://i.imgur.com/" + id + "_d.png?maxwidth=10000&fidelity=high\" target=\"_blank\" rel=\"noreferrer\"><img src=\"https://i.imgur.com/" + id + "s.png\" height=\"110\" width=\"110\" /></a>");
				}
